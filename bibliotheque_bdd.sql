...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 07 avr. 2022 à 15:51
...
--
-- Base de données : `bibliotheque_bdd`
--
...
--
-- AUTO_INCREMENT pour la table `classifier`
--
ALTER TABLE `classifier`
  MODIFY `ID_classifier` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `emprunter`
--
ALTER TABLE `emprunter`
  MODIFY `ID_emprunter` int(11) NOT NULL AUTO_INCREMENT;
